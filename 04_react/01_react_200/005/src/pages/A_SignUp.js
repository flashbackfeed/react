...
// TODO : 바인딩 : 변수의 값을 변경하면 -> 화면에 변경된 값이 바로 출력(자동)
// TODO : 역방향바인딩 : 화면의 값을 변경하면 -> 변수의 값을 변경해야됨(해주지않음)
// TODO : (바닐라 js) 1) 변수의 값을 가져와서 : querySelector()
// TODO :             2) 변수의 값을 수정해서
// TODO :             3) innerHTML로 화면에 넣기
...
function A_SignUp() {
   ...
   let [gender, setGender] = useState("남자"); // 성별(select)과 바인딩
    ...
    // TODO : 함수 정의
    //nfn
    //버튼클릭 함수 : alert() 이름, 성별을 출력하기
    const handleSubmit = (event) => { 
        //submit 버튼 : 기본특징(페이지이동) : 취소
        alert("이름 : " + name + " 성별 : " + gender);
        event.preventDefalut(); // 기본 기능 취소(방해) 함수
        
     }
    //  TODO : 역방향 바인딩(수동 코딩)
    //  TODO : 화면값 변경(event.target.value) -> 변수값 변경
     //nfn
